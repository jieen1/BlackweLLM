...
# module docstring. This is the script the "K=8, chosen when the head was
# wired up" / "e2e to prose 1.09x / code 0.905x" figures in the roadmap and
# notes/ came from, measured on the nvidia checkpoint; re-running on the
