...
> 最后整理：2026-08-11 · prefill 方案审计基线 commit `0e3e10a`
...
| [`dsv4-prefill-2k-implementation-plan.md`](dsv4-prefill-2k-implementation-plan.md) | DSV4 单卡 prefill ≥2000 tok/s：Phase 0/1 prototype 状态、exact kernel kill-gate 结果、Phase 2B scale-amortized Tensor-Core 路线和发布门禁 | 任一阶段完成、性能预算变化、目标约束变化 |
