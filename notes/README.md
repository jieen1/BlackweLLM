...
- [2026-08-04 Qwen3.6 W4A16 profile 与分相试验](2026-08-04-qwen36-w4a16-profile-and-split-plan.md) —— 🟢 当前 W1-S trace 的可复现 phase 分解、W4A4 明确排除、已提交的 barrier-clear 小修，以及保留原始 W4A16/BF16-activation 语义的 opt-in FC1/FC2 分相验证门槛。
