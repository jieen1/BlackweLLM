...
- [2026-08-04 Qwen3.6 W4A16 profile 与分相试验](2026-08-04-qwen36-w4a16-profile-and-split-plan.md) —— 🟢 当前 W1-S trace 的可复现 phase 分解、W4A4 明确排除、已提交的 barrier-clear 小修；FC1/FC2 分相在完整 CUDA Graph 下 **43.148→48.612 ms/verify 回退**，已记录为拒绝实验，未合入默认路径。
